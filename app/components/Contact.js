        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row relative min-h-[70vh]">
            ...
            <div className="w-full md:w-1/2 pr-0 md:pr-12 mb-10 mt-8 md:mb-0 flex flex-col">
              <h1 className="text-4xl font-medium mb-8 md:text-right pr-8 mt-48">
                Get in touch with Us!
              </h1>

              <div className="mt-auto md:text-right pr-8">
            ...
            <div className="w-full md:w-1/2 pl-0 md:pl-12 flex flex-col">
              <div className="mt-56">
